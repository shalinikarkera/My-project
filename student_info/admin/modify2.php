     ...
     <form id="form1" name="form1" method="get" action="modify3.php">
        <table align="center" width="291" border="0">
          ...
          <tr>
            ...
            <td><input name="phno" type="text" id="textfield2" value="<?php echo $result[2] ?>" /></td>
          </tr>
          <tr>
            <td><strong>City #:</strong></td>
            <td><input type="text" name="city" id="textfield3" value="<?php echo $result[3] ?>" /></td>
          </tr>
          <tr>
            <td><strong>Branch</strong>:</td>
            <td><input type="text" name="branch" id="textfield4" value="<?php echo $result[4] ?>" /></td>
          </tr>
        </table>
        <p align="center">
          <label>
